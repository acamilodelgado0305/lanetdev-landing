...
const TransactionVoucherSection = ({ entry, entryId }) => {
    ...
    const fetchVouchers = async () => {
        try {
            const response = await axios.get(`${API_URL}/transfers/${entryId}/vouchers`);
...
export default TransactionVoucherSection;