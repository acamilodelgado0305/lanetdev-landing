...
import TypeSelector from '../expense/TypeSelector';
...
import AmountCalculator from '../expense/AmountCalculator';
...
const Prueba = ({ isOpen, onClose, onTransactionAdded, transactionToEdit }) => {
